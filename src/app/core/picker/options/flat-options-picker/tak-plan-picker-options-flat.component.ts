...
@Component({
  selector: 'tak-plan-picker-options-flat',
  templateUrl: './tak-plan-picker-options-flat.component.html',
  styleUrls: ['./tak-plan-picker-options-flat.component.scss']
})
export class TakPlanPickerOptionsFlatComponent implements OnInit {
